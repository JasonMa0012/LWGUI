	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 color12_g5 = IsGammaSpace() ? float4( 1, 0, 0, 0 ) : float4( 1, 0, 0, 0 );
				float4 color13_g5 = IsGammaSpace() ? float4( 0, 1, 0, 0 ) : float4( 0, 1, 0, 0 );
				float4 color18_g5 = IsGammaSpace() ? float4( 0, 0, 1, 0 ) : float4( 0, 0, 1, 0 );
				#if defined( _ENABLE_RED )
				float3 staticSwitch8_g5 = color12_g5.rgb;
				#elif defined( _ENABLE_GREEN )
				float3 staticSwitch8_g5 = color13_g5.rgb;
				#elif defined( _ENABLE_BLUE )
				float3 staticSwitch8_g5 = color18_g5.rgb;
				#else
				float3 staticSwitch8_g5 = color12_g5.rgb;
				#endif
